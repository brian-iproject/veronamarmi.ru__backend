...
<div class="calculator">
	...
	<form action="/" method="POST" id="ajax_form">
		<input type="hidden" name="dirs" value="Калькулятор стола">
		<fieldset>
			<article>
				<header><strong>Шаг</strong><span>1</span>Выберите форму столешницы</header>
				<ul class="checks_forms hover_block">
					<li>
						<div onclick="getCalcSizes('2')">
						...
						<a href="#" onclick="return false;">
							...
							<img style="top: 0px; width: 172px;" src="/calculators/img/5ce5972e59534f860528b7f99e0c88a2.jpg" alt="прямая кухня" title="прямая кухня">
						</a>
					</li>
					<li>
						<div onclick="getCalcSizes('3')">
						...
						<a href="#" onclick="return false;">
							...
							<img style="top: 0px; width: 172px;" src="/calculators/img/b6b67c54b29305b88027598007afee67.jpg" alt="Г-образная" title="Г-образная">
						</a>
					</li>
					<li>
						<div onclick="getCalcSizes('4')">
						...
						<a href="#" onclick="return false;">
							...
							<img style="top: 0px; width: 172px;" src="/calculators/img/caecb012cb40661bab49ff948e7e51f1.jpg" alt="П-образная кухня" title="П-образная кухня">
						</a>
					</li>
					<li>
						<div onclick="getCalcSizes('5')">
							<input type="radio" name="fld[calc_forms]" class="customRadio4" id="check4" value="4">
							<label for="check4">4</label>
						</div>
						<a href="#" onclick="return false;">
							<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/68815057b037e98fd3622dad5dcf4a3f.JPG" alt="" title=""></span>
							<img style="top: 0px; width: 172px;" src="/calculators/img/aa66cf7dd74555f2d7933c438cdfabdb.jpg" alt="" title="">
						</a>
					</li>
					<li>
						<div onclick="getCalcSizes('14')">
							<input type="radio" name="fld[calc_forms]" class="customRadio4" id="check5" value="5">
							<label for="check5">5</label>
						</div>
						<a href="#" onclick="return false;">
							<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/83a961daa5111a03cb322a258fd6bc3f.jpg" alt="" title=""></span>
							<img style="top: 0px; width: 172px;" src="/calculators/img/53102300542fabdb95ad024e94ec0786.jpg" alt="" title="">
						</a>
					</li>
					<li>
						<div onclick="getCalcSizes('15')">
							<input type="radio" name="fld[calc_forms]" class="customRadio4" id="check6" value="6">
							<label for="check6">6</label>
						</div>
						<a href="#" onclick="return false;">
							<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/56c4e510a27b41b8314c12e02b339426.jpg" alt="" title=""></span>
							<img style="top: 0px; width: 172px;" src="/calculators/img/8f5bfc693cf3921479656cf5099ac2e3.JPG" alt="" title="">
						</a>
					</li>
				</ul>
				<div class="c"></div>
			...
			<div id="calcSizes">
				...
				<div class="calcHidden" style="display:none;">
					...
					<article>
						<header><strong>Шаг</strong><span>4</span>Выберите тип профиля и укажите высоту для пристеночного бортика</header>
						<a href="#" onclick="jQuery('.profil').removeAttr('checked'); return false;" title="очистить">очистить</a>
						<ul class="checks_forms hover_block">
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="1" id="profilbortik1">
									<label for="profilbortik1">1</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/123.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/37a653eef2eff6786975ec33f1d355e7.JPG" alt="" title="">
								</a>
							</li>
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="2" id="profilbortik2">
									<label for="profilbortik2">2</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/fe5990c0e9eea976bc05f70a018e790e.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/9d6088f8d2b3aa93e20b3fb99dc8ebe6.jpg" alt="" title="">
								</a>
							</li>
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="3" id="profilbortik3">
									<label for="profilbortik3">3</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/18d144ab053191f236b0b6ee345bf4e0.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/56f84fcf09388cf17500597fb2f847b8.JPG" alt="" title="">
								</a>
							</li>
						</ul>
						<div class="c"></div>
						<ul class="checks_forms hover_block">
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="4" id="profilbortik4">
									<label for="profilbortik4">4</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/19403d1541a9b9719e2782695aacb0ba.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/3cc51250307f3099c39bf9e26c44d2c0.JPG" alt="" title="">
								</a>
							</li>
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="5" id="profilbortik5">
									<label for="profilbortik5">5</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/585eca11e6d7fc63667801206ddd4127.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/915ffa0e0b107cc6af62af78bba8ed0f.JPG" alt="" title="">
								</a>
							</li>
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="6" id="profilbortik6">
									<label for="profilbortik6">6</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/2b745773e2e245da50dab8deb5dcb256.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/80d9488346484b31f6b692ac6b438b63.jpg" alt="" title="">
								</a>
							</li>
						</ul>
						<div class="c"></div>
						<ul class="checks_forms hover_block">
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="7" id="profilbortik7">
									<label for="profilbortik7">7</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/91fc78955b4a6817d3c05066c7ff2e54.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/34744fdc3ef9047e6f4c5cf299e1cbf9.jpg" alt="" title="">
								</a>
							</li>
							<li>
								<div>
									<input class="customRadio3 profil" type="radio" name="fld[TorProfilBortik]" value="8" id="profilbortik8">
									<label for="profilbortik8">8</label>
								</div>
								<a href="#" onclick="return false;">
									<span class="renderedImage" style="overflow: hidden;"><img style="top: 0px;" src="/calculators/img/5716456b4127870e4f69c95a845296cd.jpg" alt="" title=""></span>
									<img style="top: 0px;" src="/calculators/img/7a213db288e8d7ec5b6df38596853cdb.jpg" alt="" title="">
								</a>
							</li>
						</ul>
						<div class="c"></div>
						<table style="margin: 0 0 0 30px;">
							...
							<tr>
								<td class="value">
									Высота пристеночного бортика&nbsp;
								</td>
								<td class="value" style="width: 100px;">
									<div class="input">
										<input type="text" id="heightBortik" name="fld[heightBortik]" value="">
									</div>
								</td>
								<td class="value">
									&nbsp;&nbsp;mm
					...
					<article style="position:relative;">
						...
						<div class="dop__input">
							<input type="text" name="fld[rakovin]" value="0" />Раковин
							<br />
							<input type="text" name="fld[panel]" value="0" />Варочных панелей
						</div>
					</article>
					<article>
