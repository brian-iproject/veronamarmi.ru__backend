...
<div class="catalog">
  <? if (file_exists($_SERVER['DOCUMENT_ROOT'].'/includes-area/catalog/top-text.php')) { ?>
	  <div class="catalog__top-text important-text">
	    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	        "AREA_FILE_SHOW" => "file",
	        "PATH" => "/includes-area/catalog/top-text.php",
	        "EDIT_TEMPLATE" => ""
	    ),
	        $component
	    );?>
  ...
  <? if (file_exists($_SERVER['DOCUMENT_ROOT'].'/includes-area/catalog/bottom-text.php')) { ?>
		<div class="catalog__bottom-text">
	    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	        "AREA_FILE_SHOW" => "file",
	        "PATH" => "/includes-area/catalog/bottom-text.php",
	        "EDIT_TEMPLATE" => ""
	    ),
	        $component
	    );?>
