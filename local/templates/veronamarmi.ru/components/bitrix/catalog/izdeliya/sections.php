...
?>
<div class="products">
  <? if (file_exists($_SERVER['DOCUMENT_ROOT'].'/includes-area/izdeliya/top-text.php')) { ?>
		<div class="products__top-text important-text">
	    <?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
	        "AREA_FILE_SHOW" => "file",
	        "PATH" => "/includes-area/izdeliya/top-text.php",
	        "EDIT_TEMPLATE" => ""
	    ),
	        $component
	    );?>
  ...
  <? if (file_exists($_SERVER['DOCUMENT_ROOT'].'/includes-area/izdeliya/bottom-text.php') && $GLOBALS['CATALOG_PAGE_NUM'] == 1) { ?>
		<div class="products__bottom-text">
			<?$APPLICATION->IncludeComponent("bitrix:main.include", ".default", array(
			    "AREA_FILE_SHOW" => "file",
			    "PATH" => "/includes-area/izdeliya/bottom-text.php",
			    "EDIT_TEMPLATE" => ""
			),
			    $component
			);?>
