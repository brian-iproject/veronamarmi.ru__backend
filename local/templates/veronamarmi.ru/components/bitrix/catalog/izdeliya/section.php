...
?>
<div class="products">
  <?$APPLICATION->ShowViewContent('banner')?>
  <?
  ...
  <?$APPLICATION->ShowViewContent('stones')?>
  ...
  <?$intSectionID = $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "SECTION_USER_FIELDS" => array("UF_TOP_DESCRIPTION", "UF_VARIANTS_STONES", "UF_VARIANTS_STONES_E", "UF_PAGE_BANNER", "UF_CALL2ACTION_TITLE", "UF_FAQ", "UF_HEADING_PRODUCTS", ""),
  ...
  <? if ($GLOBALS['CATALOG_STONES_SECTION_ID'] || $GLOBALS['CATALOG_STONES_ELEMET_ID']) { ?>
    ...
    <? $this->EndViewTarget('stones'); ?>
  <? } ?>

  <? if ($GLOBALS['CALL2ACTION_TITLE']) { ?>
		<div class="full-screen">
			<div class="full-screen__inner">
				<div class="consultation-form">
					<div class="consultation-form__inner container--fluid">
						<div class="consultation-form__text">
							<div class="consultation-form__title"><?=$GLOBALS['CALL2ACTION_TITLE']?></div>
							<p>Оставьте контакты, мы перезвоним, ответим на вопросы и поможем с выбором!</p>
						</div>
