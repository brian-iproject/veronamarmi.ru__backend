...
if($this->StartResultCache())
{
	...
	else
	{
		...
		$rsSections = CIBlockSection::GetList($arOrder, array_merge($arFilter , $arrFilter), false, array(
			"ID",
			"DEPTH_LEVEL",
			"NAME",
			"SECTION_PAGE_URL",
		...
		while($arSection = $rsSections->GetNext())
		{
			$arResult["SECTIONS"][] = array(
				...
				"~NAME" => $arSection["~UF_NAME_FOR_MENU"]?$arSection["~UF_NAME_FOR_MENU"]:$arSection["~NAME"],
